...
M.setup = function(opts)
  ...
  vim.api.nvim_create_user_command('PickupEchoOnCursor', notes.pickup_echo_note_on_cursor, {})
  vim.api.nvim_create_user_command('DropEchoOnCursor', notes.drop_echo_note_on_cursor, {})
